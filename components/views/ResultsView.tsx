        ...
        sorted.length === 0 ? (
          ...
          sorted.map((deal, i) => (
            <tr key={deal.id} className={`hover:bg-gray-50 transition-colors ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/40'}`}>
              ...
              <td className="px-5 py-2.5 text-right text-gray-600 truncate max-w-0" title={deal.owner}>{deal.owner}</td>
              ...
              <td className="px-5 py-2.5 text-right text-gray-500 hidden lg:table-cell">{pct(deal.probability)}</td>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm table-fixed">
            <colgroup>
              ...
              <col className="hidden md:table-column" style={{ width: '150px' }} />
