        ...
        <table className="w-full text-sm table-fixed">
          ...
          <thead>
            <tr className="bg-gray-50/70 border-b border-gray-200">
              <th className="px-4 py-3 text-left text-[12px] font-bold uppercase tracking-[0.1em] text-slate-600">Area</th>
              <th className="px-4 py-3 text-right text-[12px] font-bold uppercase tracking-[0.1em] text-slate-600">SD Forecast</th>
              <th className="px-4 py-3 text-right text-[12px] font-bold uppercase tracking-[0.1em] text-slate-600">YoY</th>
              <th className="px-4 py-3 text-right text-[12px] font-bold uppercase tracking-[0.1em] text-slate-600">vs M</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-baseline gap-2.5">
            ...
            <span className="text-[13px] font-bold text-slate-500 uppercase tracking-wider">Monthly Results</span>
          </div>
          <select
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-baseline gap-2.5">
            ...
            <span className="text-[13px] font-bold text-slate-500 uppercase tracking-wider">Quarterly Results</span>
          </div>
          <select
